...
end_date = ymd_hms("2014-12-30 08:00:00")
...
for (i in 1:365){
  ...
  train.ho.a <- holt(ts1,h=40, season = "additive")
...
for (i in 1:365){
  ...
  train.ho.a <- holt(ts1, h= 40,season = "Multiplicative")
  #train.ho.m <- holt(train_new, season = "Multiplicative")
  #predictions = predict(train.ho.a,prediction.interval = FALSE)
  #train.ho.a['fitted']
  #autoplot(train.ho.a)
  #predictions = predict(ts1,h=40)
  Prediction = train.ho.a[['mean']]
  z = Prediction[17:40]
  mape = MLmetrics::MAPE(ts2[17:40], z)
